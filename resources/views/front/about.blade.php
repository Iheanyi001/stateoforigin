...
<main role="main" aria-label="main">
    <!-- Who we are section -->
    <section class="mt-8 about-section">
      <div
        data-aos="fade-up"
        data-aos-offset="50"
      ...
      >
        ...
        <div class="about-paragraph">
          <p>
            The Abia State of Origin and Local Government of Origin
          ...
          <p>
            ...
            one's roots and local connections, we at Abia State have developed
    ...
    <div class="container">
      ...
      <div data-aos="fade-down" data-aos-duration="1000" class="mt-3">
        <p>
          We are a state in southwestern Nigeria; bounded to the east by Ekiti
          and Ondo states, to the north by Kwara State, to the south by Ogun
          State and to the west by Oyo State. Named for the River Abia—a vital
          river which flows through the state—the state was formed from the
          southeast of Oyo State on 27 August 1991 and has its capital as the
          city of Osogbo.
        </p>
        <p>
          Of the 36 states of Nigeria, Abia is the ninth smallest in area and
          nineteenth most populous with an estimated population of about 4.7
          million as of 2016. Geographically, the state is divided between the
          Nigerian lowland forests in most of the state and the drier Guinean
          forest–savanna mosaic in the north. The major geographical features
          are rivers including the state’s namesake, the River Abia which
          bisects the state’s interior before forming much of the state’s
          southwestern border with Oyo State and flowing south. Other
          important rivers are the Erinle and Oba rivers, both Abia
          tributaries which flow from the north before meeting the Abia along
          the southwestern border. Among the state’s fauna are mona monkey,
          common kestrel, purple heron, and royal antelope, along with some of
          Nigeria’s last remaining Nigeria-Cameroon chimpanzee and African
          forest elephant which inhabit the heavily threatened forests along
          the southern borders with Ondo and Ogun states.
        </p>
        <p>
          The name ‘’Abia’’ comes from a river that flows through the state.
          It is symbolic because it serves both spiritual and tourist purposes
          in the state. The river is worshipped annually by devotees. It is
          also a tourist spot as people from different parts of the country
          visit the Abia Groove in Osogbo. The river also provides water for
          irrigation for the agriculturally rich state.
        </p>
      </div>
    </div>
        ...
        >
          <div class="faq-content" onclick="toggleFAQ('faq1')">
            ...
            <p class="faq-body" id="faq1">
              ...
              <a href="ttps://apply.stateoforigin.abiastate.gov.ng/"
                >https://apply.stateoforigin.abiastate.gov.ng/</a
              >
    ...
    <section id="contact" class="pt-5 contact-section">
      ...
      >
        ...
        <div class="form__group">
          <label class="form__label"> Subject of your Message </label>
          <input
            type="text"
            class="form__input"
        ...
        <div class="form__group element-four">
        ...
        <div class="form__group element-five">
          <div class="mail-us">
            <a
              href="https://wa.me/2347026376105"
              class="whatsapp"
              target="_blank"
            ...
            <a
              class="whatsapp"
              href="mailto:info@originabia.electroniccollectionsecg.com"
              >Email us</a
            >
          </div>
          <button class="btn-submit" onclick="submitForm()" disabled>
            <a href="# ">Submit</a>
          </button>
        </div>
      </form> -->
      <div class="contact-boxs">
        ...
        <div class="contact-box">
          <a href="tel:+2347026376105" class="whatsapp" target="_blank">
