    ...
    <div class="container">
      ...
      <div data-aos="fade-down" data-aos-duration="1000" class="mt-3">
        <p>
          ...
          State and to the west by Oyo State. Named for the River Rivers—a vital
        ...
        <p>
          Of the 36 states of Nigeria, Rivers is the ninth smallest in area and
          ...
          are rivers including the state’s namesake, the River Rivers which
          ...
          important rivers are the Erinle and Oba rivers, both Rivers
          tributaries which flow from the north before meeting the Rivers along
        ...
        <p>
          The name ‘’Rivers’’ comes from a river that flows through the state.
          ...
          visit the Rivers Groove in Osogbo. The river also provides water for
        ...
        >
          <div class="faq-content" onclick="toggleFAQ('faq1')">
            ...
            <p class="faq-body" id="faq1">
              ...
              <a href="{{route('login')}}"
                >https://apply.stateoforigin.riversstate.gov.ng/</a
              >
      ...
      >
        ...
        <div class="form__group element-five">
          <div class="mail-us">
            ...
            <a
              class="whatsapp"
              href="mailto:info@originrivers.electroniccollectionsecg.com"
              >Email us</a
            >
          </div>
