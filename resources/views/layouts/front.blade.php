...
<!-- Mirrored from stateoforigin.abiastate.gov.ng/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jun 2024 16:06:03 GMT -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta
      name="description"
      content="The Abia State of Origin and Local Government of Origin Certificate Portal
offers a streamlined procedure for acquiring the official State of Origin and
Local Government of Origin Certificate in Abia State"
    />
   ...
   >
     <div class="container nav__container">
       <div class="logo" style="vertical-align: middle; padding-top:10px">
         <img src="{{asset('assets/abia-logo.png')}}" alt="logo" class="icon-"
         style="width:70px"/>
       </div>
       <div class="nav-left">
         <ul class="nav-list">
           ...
           <li class="nav-list-item">
             <a
               class="menu__link"
               href="https://originabia.electroniccollectionsecg.com/verify/certificate"
               >Verify</a
             >
           </li>
           <li class="nav-list-item">
    ...
    <footer>
        <div class="footer-container">
          <div class="footer-top">
            <div class="footer-content">
              ...
              <div class="mt-1 footer-content__text">
                <p>
                  Welcome to the Abia State Certificate of Origin Portal, where we
            ...
            <div class="footer-content">
              ...
              <ul class="mt-2 footer-content__list">
                <li class="footer-content__list-item">Abia State Government</li>
                <li class="footer-content__list-item">
                  Bank Road off Azikwe Road, Umuahia. Abia,
                  Nigeria.
                </li>
                <li class="footer-content__list-item">
                  +234 70111112222 ~ Support Line
                </li>
                <li class="footer-content__list-item">+2348-444556566 ~ Abia LGC</li>
                <li class="footer-content__list-item">
          ...
          <div class="footer-bottom">
            ...
            <p>&copy; 2024 Abia State and Local Governments – Powered by Abia-LGC.</p>
          </div>
        </div>
      </footer>
...
<!-- Mirrored from stateoforigin.abiastate.gov.ng/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jun 2024 16:06:08 GMT -->
</html>
