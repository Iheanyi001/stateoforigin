<form wire:submit='save' enctype="multipart/form-data">
    ...
    <div class="col-lg-12" data-section="type">
       <div class="form-group {{$application_type == '' ? 'd-block': 'd-none'}}">
          <label class="form-control-label">Application Type: <span class="tx-danger">*</span></label>
          <select wire:model.live="application_type" wire:change='set_form_show()' id="application_type" class="form-control form-select" readonly="">
             <option value="" default="">Choose application type</option>
             <option  value="sco">State of Origin Certificate</option>
             <option value="lgco">Local Government of Origin Certificate</option>
          </select>
       </div>
    </div>
    <div class="col-lg-12 {{$application_type=='sco'? 'd-block':'d-none'}}" data-section="confirm_lga">
    ...
    <div class="col-lg-12 {{$have_lgco == 'yes'? 'd-block':'d-none'}}" data-section="lga_certificate_type">
       <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="col-lg-12 {{$lga_cert_type == 'digital' ? 'd-block' : 'd-none'}}" data-section="digital_lga">
       <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="col-lg-12 {{$lga_cert_type == 'manual' ? 'd-block' : 'd-none'}}" data-section="manual_lga">
       <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="form-layout form-layout-1 {{$form_show == "show" ? 'd-block' : 'd-none'}}" data-section="form-layout">
       <div class="d-flex justify-content-between align-items-center mb-3">
       ...
       <div class="row mg-b-25" style="margin-top:20px;">
          ...
          <div class="col-lg-4">
             <div class="form-group">
                ...
                <select wire:model="lga" id="lga" class="form-control">
          ...
          <div class="col-lg-6">
             <div class="form-group">
                <label class="form-control-label">Compound/Hometown in Rivers State: <span class="tx-danger">*</span></label>
