...
@section('content')
    <main role="main" aria-label="main">
        ...
        <div class="container hero-section">
          <div data-aos="zoom-in" data-aos-duration="1500" class="hero-text">
            <h1 class="hero-header">
              Obtain Your Abia State and Local Government of Origin Certificate
              with a Few Clicks.
            </h1>
      ...
      <section class="pt-4 apply-section" id="apply">
        ...
        <div data-aos="fade-up" data-aos-duration="1000" class="apply-contents">
          ...
          <div class="apply-content">
            ...
            <p>
              ...
              verify your identity and establish your connection to Abia state.
            </p>
          </div>
          <div class="apply-content">
        ...
        <div class="btn-box">
          <button class="btn-reuse" aria-label="Apply Now">
            <a href="https://originabia.electroniccollectionsecg.com/register"
              >Get Started</a
            >
          </button>
        </div>
      ...
      <section id="contact" class="pt-5 contact-section">
        ...
        <div class="contact-boxs">
          <div class="contact-box">
            <a
            href="https://wa.me/2347013483389"
            class="whatsapp"
            target="_blank"
            >
